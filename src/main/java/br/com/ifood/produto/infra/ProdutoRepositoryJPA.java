...
//        log.info("[inicia] ProdutoRepositoryJPA - salvaFotoProduto");
//        produtoSpringDataJPA.save(fotoProduto);
//        log.info("[finaliza] ProdutoRepositoryJPA - salvaFotoProduto");
//        return fotoProduto;
//    }

    @Override
    public Optional<FotoProduto> findFotoById(Long idProduto, Long idRestaurante) {
        log.info("[inicia] ProdutoRepositoryJPA - findFotoById");
        Optional<FotoProduto> fotoExistente = produtoSpringDataJPA.findFotoById(idProduto,idRestaurante);
        log.info("[finaliza] ProdutoRepositoryJPA - findFotoById");
        return fotoExistente;
    }

//    @Override
//    public void deletaFoto(Long fotoExistente) {
//        log.info("[inicia] ProdutoRepositoryJPA - deletaFoto");
//        produtoSpringDataJPA.excluirFoto(fotoExistente);
//        log.info("[finaliza] ProdutoRepositoryJPA - deletaFoto");
//    }
